...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::route::dry_run_route,
            commands::provider::get_degraded_providers,
            commands::provider::set_responses_bridge,
            commands::provider::get_responses_bridge,
            commands::usage_dash::get_model_prices,
            commands::usage_dash::set_model_price,
            commands::usage_dash::remove_model_price,
